...
(() => {
  ...
  var require_mini_umd = __commonJS({
    "../node_modules/exifr/dist/mini.umd.js"(exports) {
      ...
      var i3 = "undefined" != typeof navigator;
      var s3 = i3 && "undefined" == typeof HTMLImageElement;
      ...
      var u3 = class {
        ...
        constructor(e4) {
          let t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i4 = arguments.length > 2 ? arguments[2] : void 0, s4 = arguments.length > 3 ? arguments[3] : void 0;
          if ("boolean" == typeof s4 && (this.le = s4), Array.isArray(e4) && (e4 = new Uint8Array(e4)), 0 === e4)
            ...
            void 0 === i4 && (i4 = e4.byteLength - t4), t4 += e4.byteOffset, t4 + i4 > e4.byteOffset + e4.byteLength && f3("Creating view outside of available memory in ArrayBuffer");
        ...
        set(e4, t4) {
          let i4 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u3;
        ...
        getString() {
          let e4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.byteLength, i4 = this.getUint8Array(e4, t4);
          return s4 = i4, d2 ? d2.decode(s4) : r3 ? Buffer.from(s4).toString("utf8") : decodeURIComponent(escape(l3(s4)));
          var s4;
        }
        getLatin1String() {
          let e4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.byteLength, i4 = this.getUint8Array(e4, t4);
      ...
      var y2 = t3.fetch;
      function w3(e4, t4) {
        return (s4 = e4).startsWith("data:") || s4.length > 1e4 ? v3(e4, t4, "base64") : n2 && e4.includes("://") ? k3(e4, t4, "url", S) : n2 ? v3(e4, t4, "fs") : i3 ? k3(e4, t4, "url", S) : void f3("Invalid input argument");
        var s4;
      }
      ...
      var j3 = class extends z2 {
        ...
        translateTagSet(e4, t4) {
          if (this.dict) {
            ...
            for (i4 of e4)
              "string" == typeof i4 ? (s4 = r4.indexOf(i4), -1 === s4 && (s4 = n3.indexOf(Number(i4))), -1 !== s4 && t4.add(Number(n3[s4]))) : t4.add(i4);
          } else
            for (let i4 of e4)
              t4.add(i4);
        }
      ...
      var N2 = class extends z2 {
        ...
        constructor(e4) {
          super(), true === e4 ? this.setupFromTrue() : void 0 === e4 ? this.setupFromUndefined() : Array.isArray(e4) ? this.setupFromArray(e4) : "object" == typeof e4 ? this.setupFromObject(e4) : f3(`Invalid options argument ${e4}`), void 0 === this.firstChunkSize && (this.firstChunkSize = i3 ? this.firstChunkSizeBrowser : this.firstChunkSizeNode), this.mergeOutput && (this.ifd1.enabled = false), this.filterNestedSegmentTags(), this.traverseTiffDependencyTree(), this.checkLoadedPlugins();
        }
        setupFromUndefined() {
          let e4;
          for (e4 of x2)
        ...
        batchEnableWithUserValue(e4, t4) {
          for (let i4 of e4) {
            let e5 = t4[i4];
            this[i4].enabled = false !== e5 && void 0 !== e5;
          }
        }
        setupGlobalFilters(e4, t4, i4) {
          let s4 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : i4;
          if (e4 && e4.length) {
            for (let e5 of s4)
        ...
        traverseTiffDependencyTree() {
          ...
          s4.needed && (t4.deps.add(40965), e4.deps.add(40965)), t4.needed && e4.deps.add(34665), i4.needed && e4.deps.add(34853), this.tiff.enabled = V.some((e5) => true === this[e5].enabled) || this.makerNote || this.userComment;
          for (let e5 of V)
      ...
      var X = class {
        ...
        async read(e4) {
          this.file = await function(e5, t4) {
            return "string" == typeof e5 ? w3(e5, t4) : i3 && !s3 && e5 instanceof HTMLImageElement ? w3(e5.src, t4) : e5 instanceof Uint8Array || e5 instanceof ArrayBuffer || e5 instanceof DataView ? new u3(e5) : i3 && e5 instanceof Blob ? k3(e5, t4, "blob", O2) : void f3("Invalid input argument");
          }(e4, this.options);
        }
        setup() {
          if (this.fileParser)
        ...
        async parse() {
          ...
          return this.setup(), this.options.silentErrors ? (await this.executeParsers().catch(this.pushToErrors), t4.push(...this.fileParser.errors)) : await this.executeParsers(), this.file.close && this.file.close(), this.options.silentErrors && t4.length > 0 && (e4.errors = t4), h2(i4 = e4) ? void 0 : i4;
          var i4;
        }
      ...
      var H2 = class {
        static findPosition(e4, t4) {
          let i4 = e4.getUint16(t4 + 2) + 2, s4 = "function" == typeof this.headerLength ? this.headerLength(e4, t4, i4) : this.headerLength, n3 = t4 + s4, r4 = i4 - s4;
          return {
            offset: t4,
            length: i4,
            headerLength: s4,
        ...
        constructor(t4) {
          let i4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, s4 = arguments.length > 2 ? arguments[2] : void 0;
        ...
        translateBlock(e4, t4) {
          let i4 = I2.get(t4), s4 = A2.get(t4), n3 = U.get(t4), r4 = this.options[t4], a4 = r4.reviveValues && !!i4, h3 = r4.translateValues && !!s4, f4 = r4.translateKeys && !!n3, o4 = {};
          for (let [t5, r5] of e4)
            a4 && i4.has(t5) ? r5 = i4.get(t5)(r5) : h3 && s4.has(t5) && (r5 = this.translateValue(r5, s4.get(t5))), f4 && n3.has(t5) && (t5 = n3.get(t5) || t5), o4[t5] = r5;
          return o4;
        }
        ...
        constructor(t4, i4, s4) {
          e3(this, "errors", []), e3(this, "ensureSegmentChunk", async (e4) => {
            ...
            if (this.file.chunked) {
              ...
              this.file.byteLength > t5 + i5 ? e4.chunk = this.file.subarray(t5, i5) : void 0 === e4.size ? e4.chunk = this.file.subarray(t5) : f3("Segment unreachable: " + JSON.stringify(e4));
            return e4.chunk;
        ...
        async findAppSegments() {
          ...
          if (!s4 && this.file.chunked && (s4 = Array.from(n3).some((e5) => {
            ...
            for (; r4.size > 0 && !t5 && (i4.canReadNextChunk || this.unfinishedMultiSegment); ) {
              ...
              if (t5 = e4 > s5 && !n4 ? !await i4.readNextChunk(e4) : !await i4.readNextChunk(s5), e4 = this.findAppSegmentsInRange(e4, i4.byteLength), void 0 === e4)
                return;
            }
          }
        }
          ...
          for (; e4 < t4; e4++)
            if (255 === f4.getUint8(e4)) {
              if (i4 = f4.getUint8(e4 + 1), Y(i4)) {
                ...
                if (s4 = f4.getUint16(e4 + 2), 218 === i4 && false !== u4.stopAfterSos)
                  return;
      ...
      var J = class extends H2 {
        ...
        parseTags(e4, t4) {
          let i4 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : /* @__PURE__ */ new Map(), {
            pick: s4,
            skip: n3
          } = this.options[t4];
          s4 = new Set(s4);
          ...
          for (let f4 = 0; f4 < h3; f4++) {
            ...
            if (r4) {
              if (s4.has(h4) && (i4.set(h4, this.parseTag(e4, h4, t4)), s4.delete(h4), 0 === s4.size))
                break;
            } else
              !a4 && n3.has(h4) || i4.set(h4, this.parseTag(e4, h4, t4));
            e4 += 12;
          }
          return i4;
        }
        parseTag(e4, t4, i4) {
          ...
          if (a4 * r4 <= 4 ? e4 += 8 : e4 = s4.getUint32(e4 + 8), (n3 < 1 || n3 > 13) && f3(`Invalid TIFF value type. block: ${i4.toUpperCase()}, tag: ${t4.toString(16)}, type: ${n3}, offset ${e4}`), e4 > s4.byteLength && f3(`Invalid TIFF value offset. block: ${i4.toUpperCase()}, tag: ${t4.toString(16)}, type: ${n3}, offset ${e4} is outside of chunk size ${s4.byteLength}`), 1 === n3)
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e4.byteLength}`), e4.tiff && await e4.ensureChunk(this.ifd0Offset, o3(this.options));
  ...
  var nanoid = function(size) {
    ...
    let i3 = size;
    while (i3--) {
      id17 += urlAlphabet[Math.random() * 64 | 0];
    }
    return id17;
  };
  ...
  function generateFileID(file) {
    ...
    if (typeof file.name === "string") {
      id17 += `-${encodeFilename(file.name.toLowerCase())}`;
    }
    if (file.type !== void 0) {
      id17 += `-${file.type}`;
    }
    if (file.meta && typeof file.meta.relativePath === "string") {
      id17 += `-${encodeFilename(file.meta.relativePath.toLowerCase())}`;
    }
    if (file.data.size !== void 0) {
      id17 += `-${file.data.size}`;
    }
    if (file.data.lastModified !== void 0) {
      id17 += `-${file.data.lastModified}`;
    }
    return id17;
  }
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
    ...
    getPlugin(id17) {
      for (const plugins of Object.values(_classPrivateFieldLooseBase3(this, _plugins)[_plugins])) {
        const foundPlugin = plugins.find((plugin) => plugin.id === id17);
        if (foundPlugin != null)
          return foundPlugin;
      }
      return void 0;
  ...
  function w(n2, l3, u3, i3, t3, o3, r3, c3, s3, a3) {
    var h2, y2, d2, k3, b3, g3, w3, x2 = i3 && i3.__k || e, C2 = x2.length;
    ...
    for (u3.__e = g3, h2 = C2; h2--; )
      null != x2[h2] && ("function" == typeof u3.type && null != x2[h2].__e && x2[h2].__e == u3.__d && (u3.__d = _(i3, h2 + 1)), N(x2[h2], x2[h2]));
    if (w3)
      ...
      n:
        if ("function" == typeof H2) {
          if (g3 = u3.props, m3 = (a3 = H2.contextType) && t3[a3.__c], x2 = a3 ? m3 ? m3.props.value : a3.__ : t3, i3.__c ? b3 = (h2 = u3.__c = i3.__c).__ = h2.__E : ("prototype" in H2 && H2.prototype.render ? u3.__c = h2 = new H2(g3, x2) : (u3.__c = h2 = new d(g3, x2), h2.constructor = H2, h2.render = O), m3 && m3.sub(h2), h2.props = g3, h2.state || (h2.state = {}), h2.context = x2, h2.__n = t3, v3 = h2.__d = true, h2.__h = []), null == h2.__s && (h2.__s = h2.state), null != H2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = s({}, h2.__s)), s(h2.__s, H2.getDerivedStateFromProps(g3, h2.__s))), y2 = h2.props, _3 = h2.state, v3)
            ...
            if (null == H2.getDerivedStateFromProps && g3 !== y2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(g3, x2), !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(g3, h2.__s, x2) || u3.__v === i3.__v) {
  ...
  function L(l3, u3, i3, t3, o3, r3, e3, c3) {
    var s3, h2, v3, y2 = i3.props, p3 = u3.props, d2 = u3.type, k3 = 0;
    ...
    if (null === d2)
      ...
      if (C(l3, p3, y2, o3, c3), v3)
        u3.__k = [];
      else if (k3 = u3.props.children, w(l3, Array.isArray(k3) ? k3 : [k3], u3, i3, t3, o3 && "foreignObject" !== d2, r3, e3, r3 ? r3[0] : i3.__k && _(i3, 0), c3), null != r3)
        for (k3 = r3.length; k3--; )
          null != r3[k3] && a(r3[k3]);
 ...
 ${info.details}`)
  ...
  var import_mini_umd = __toESM(require_mini_umd(), 1);
    ...
    constructor(props) {
      ...
      this.renderMetaFields = () => {
        ...
        return metaFields.map((field) => {
          const id17 = `uppy-Dashboard-FileCard-input-${field.id}`;
    ...
    constructor(uppy, _opts) {
      ...
      this.showPanel = (id17) => {
        ...
        const activePickerPanel = targets.filter((target) => {
          return target.type === "acquirer" && target.id === id17;
        })[0];
        this.setPluginState({
          activePickerPanel,
  ...
  var getName = (id17) => {
    return id17.split("-").map((s3) => s3.charAt(0).toUpperCase() + s3.slice(1)).join(" ");
  };
  var Provider = class extends RequestClient {
    ...
    fileUrl(id17) {
      return `${this.hostname}/${this.id}/get/${id17}`;
    }
  ...
  var SearchProvider = class extends RequestClient {
    ...
    fileUrl(id17) {
      return `${this.hostname}/search/${this.id}/get/${id17}`;
    }
    search(text, queries) {
  ...
  var Breadcrumbs_default = (props) => {
    ...
    }, breadcrumbsIcon), directories.map((directory, i3) => h(Breadcrumb, {
      key: directory.id,
  ...
  var ProviderView = class extends View {
    ...
    getFolder(id17, name) {
      return this.sharedHandler.loaderWrapper(this.provider.list(id17), (res) => {
        const folders = [];
        const files = [];
        let updatedDirectories;
        const state = this.plugin.getPluginState();
        const index = state.directories.findIndex((dir) => id17 === dir.id);
        if (index !== -1) {
    ...
    addFolder(folder) {
      ...
      return this.listAllFiles(folder.requestPath).then((files) => {
        let count = 0;
        files.forEach((file) => {
          const id17 = this.providerFileToId(file);
          if (!this.plugin.uppy.checkIfFileAlreadyExists(id17)) {
            count++;
          }
        });
        if (count > 0) {
  ...
  var _enableMirror = /* @__PURE__ */ _classPrivateFieldLooseKey10("enableMirror");
  var Webcam = class extends UIPlugin_default {
    constructor(uppy, opts) {
      ...
      _classPrivateFieldLooseBase10(this, _enableMirror)[_enableMirror] = this.opts.mirror;
      this.install = this.install.bind(this);
    ...
    start(options) {
      ...
      if (this.opts.mirror) {
        _classPrivateFieldLooseBase10(this, _enableMirror)[_enableMirror] = true;
      }
    ...
    stopRecording() {
      ...
      return stopped.then(() => {
        ...
        try {
          ...
          _classPrivateFieldLooseBase10(this, _enableMirror)[_enableMirror] = false;
        } catch (err) {
          if (!err.isRestriction) {
            this.uppy.log(err);
          }
    ...
    render() {
      ...
      return h(
        ...
        _extends6({}, webcamState, {
          ...
          mirror: _classPrivateFieldLooseBase10(this, _enableMirror)[_enableMirror],
          src: this.stream
        })
      );
    }
  ...
  var _draw = /* @__PURE__ */ _classPrivateFieldLooseKey11("draw");
  var AudioOscilloscope = class {
    ...
    draw() {
      ...
      requestAnimationFrame(_classPrivateFieldLooseBase11(this, _draw)[_draw]);
    }
  };
  ...
  var _stream = /* @__PURE__ */ _classPrivateFieldLooseKey12("stream");
  var _audioActive = /* @__PURE__ */ _classPrivateFieldLooseKey12("audioActive");
  var _recordingChunks = /* @__PURE__ */ _classPrivateFieldLooseKey12("recordingChunks");
  var _recorder = /* @__PURE__ */ _classPrivateFieldLooseKey12("recorder");
  var _capturedMediaFile = /* @__PURE__ */ _classPrivateFieldLooseKey12("capturedMediaFile");
  var _mediaDevices = /* @__PURE__ */ _classPrivateFieldLooseKey12("mediaDevices");
  var _supportsUserMedia = /* @__PURE__ */ _classPrivateFieldLooseKey12("supportsUserMedia");
  var _hasAudioCheck = /* @__PURE__ */ _classPrivateFieldLooseKey12("hasAudioCheck");
  var _start = /* @__PURE__ */ _classPrivateFieldLooseKey12("start");
  var _startRecording = /* @__PURE__ */ _classPrivateFieldLooseKey12("startRecording");
  var _stopRecording = /* @__PURE__ */ _classPrivateFieldLooseKey12("stopRecording");
  var _discardRecordedAudio = /* @__PURE__ */ _classPrivateFieldLooseKey12("discardRecordedAudio");
  var _submit = /* @__PURE__ */ _classPrivateFieldLooseKey12("submit");
  var _stop = /* @__PURE__ */ _classPrivateFieldLooseKey12("stop");
  var _getAudio = /* @__PURE__ */ _classPrivateFieldLooseKey12("getAudio");
  var _changeSource = /* @__PURE__ */ _classPrivateFieldLooseKey12("changeSource");
  var _updateSources = /* @__PURE__ */ _classPrivateFieldLooseKey12("updateSources");
  var Audio = class extends UIPlugin_default {
    constructor(uppy, opts) {
      ...
      Object.defineProperty(this, _start, {
        ...
        value: function(options) {
          ...
          if (!_classPrivateFieldLooseBase12(_this, _supportsUserMedia)[_supportsUserMedia]) {
            return Promise.reject(new Error("Microphone access not supported"));
          }
          _classPrivateFieldLooseBase12(_this, _audioActive)[_audioActive] = true;
          _classPrivateFieldLooseBase12(_this, _hasAudioCheck)[_hasAudioCheck]().then((hasAudio) => {
            _this.setPluginState({
              hasAudio
            });
            return _classPrivateFieldLooseBase12(_this, _mediaDevices)[_mediaDevices].getUserMedia({
              audio: true
            }).then((stream) => {
              _classPrivateFieldLooseBase12(_this, _stream)[_stream] = stream;
              let currentDeviceId = null;
              ...
              _classPrivateFieldLooseBase12(_this, _updateSources)[_updateSources]();
              _this.setPluginState({
                currentDeviceId,
                audioReady: true
              });
      ...
      Object.defineProperty(this, _startRecording, {
        writable: true,
        value: () => {
          _classPrivateFieldLooseBase12(this, _recorder)[_recorder] = new MediaRecorder(_classPrivateFieldLooseBase12(this, _stream)[_stream]);
          _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks] = [];
          let stoppingBecauseOfMaxSize = false;
          _classPrivateFieldLooseBase12(this, _recorder)[_recorder].addEventListener("dataavailable", (event) => {
            _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks].push(event.data);
            const {
              restrictions
            } = this.uppy.opts;
            if (_classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks].length > 1 && restrictions.maxFileSize != null && !stoppingBecauseOfMaxSize) {
              const totalSize = _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks].reduce((acc, chunk) => acc + chunk.size, 0);
              const averageChunkSize = (totalSize - _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks][0].size) / (_classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks].length - 1);
              const expectedEndChunkSize = averageChunkSize * 3;
              const maxSize = Math.max(0, restrictions.maxFileSize - expectedEndChunkSize);
              if (totalSize > maxSize) {
                stoppingBecauseOfMaxSize = true;
                this.uppy.info(this.i18n("recordingStoppedMaxSize"), "warning", 4e3);
                _classPrivateFieldLooseBase12(this, _stopRecording)[_stopRecording]();
              }
            }
          });
          _classPrivateFieldLooseBase12(this, _recorder)[_recorder].start(500);
          this.recordingLengthTimer = setInterval(() => {
            const currentRecordingLength = this.getPluginState().recordingLengthSeconds;
            this.setPluginState({
              recordingLengthSeconds: currentRecordingLength + 1
      ...
      Object.defineProperty(this, _stopRecording, {
        ...
        value: () => {
          const stopped = new Promise((resolve) => {
            _classPrivateFieldLooseBase12(this, _recorder)[_recorder].addEventListener("stop", () => {
              resolve();
            });
            _classPrivateFieldLooseBase12(this, _recorder)[_recorder].stop();
            clearInterval(this.recordingLengthTimer);
            this.setPluginState({
              recordingLengthSeconds: 0
            });
          ...
          return stopped.then(() => {
            ...
            return _classPrivateFieldLooseBase12(this, _getAudio)[_getAudio]();
          }).then((file) => {
            try {
              _classPrivateFieldLooseBase12(this, _capturedMediaFile)[_capturedMediaFile] = file;
              this.setPluginState({
            ...
            _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks] = null;
            _classPrivateFieldLooseBase12(this, _recorder)[_recorder] = null;
          }, (error) => {
            _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks] = null;
            _classPrivateFieldLooseBase12(this, _recorder)[_recorder] = null;
            throw error;
      ...
      Object.defineProperty(this, _discardRecordedAudio, {
        ...
        value: () => {
          ...
          _classPrivateFieldLooseBase12(this, _capturedMediaFile)[_capturedMediaFile] = null;
        }
      });
      Object.defineProperty(this, _submit, {
        ...
        value: () => {
          try {
            if (_classPrivateFieldLooseBase12(this, _capturedMediaFile)[_capturedMediaFile]) {
              this.uppy.addFile(_classPrivateFieldLooseBase12(this, _capturedMediaFile)[_capturedMediaFile]);
            }
          } catch (err) {
            if (!err.isRestriction) {
              this.uppy.log(err, "error");
      ...
      Object.defineProperty(this, _stop, {
        writable: true,
        value: async () => {
          if (_classPrivateFieldLooseBase12(this, _stream)[_stream]) {
            const audioTracks = _classPrivateFieldLooseBase12(this, _stream)[_stream].getAudioTracks();
            audioTracks.forEach((track) => track.stop());
          }
          if (_classPrivateFieldLooseBase12(this, _recorder)[_recorder]) {
            await new Promise((resolve) => {
              _classPrivateFieldLooseBase12(this, _recorder)[_recorder].addEventListener("stop", resolve, {
                once: true
              });
              _classPrivateFieldLooseBase12(this, _recorder)[_recorder].stop();
              clearInterval(this.recordingLengthTimer);
          ...
          _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks] = null;
          _classPrivateFieldLooseBase12(this, _recorder)[_recorder] = null;
          _classPrivateFieldLooseBase12(this, _audioActive)[_audioActive] = false;
          _classPrivateFieldLooseBase12(this, _stream)[_stream] = null;
          this.setPluginState({
            recordedAudio: null,
            isRecording: false,
            recordingLengthSeconds: 0
      ...
      Object.defineProperty(this, _changeSource, {
        writable: true,
        value: (deviceId) => {
          _classPrivateFieldLooseBase12(this, _stop)[_stop]();
          _classPrivateFieldLooseBase12(this, _start)[_start]({
            deviceId
          });
        }
      });
      Object.defineProperty(this, _updateSources, {
        writable: true,
        value: () => {
          _classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices].enumerateDevices().then((devices) => {
            this.setPluginState({
      ...
      _classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices] = navigator.mediaDevices;
      _classPrivateFieldLooseBase12(this, _supportsUserMedia)[_supportsUserMedia] = _classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices] != null;
    ...
    render() {
      if (!_classPrivateFieldLooseBase12(this, _audioActive)[_audioActive]) {
        _classPrivateFieldLooseBase12(this, _start)[_start]();
      }
      ...
      return h(
        ...
        _extends7({}, audioState, {
          audioActive: _classPrivateFieldLooseBase12(this, _audioActive)[_audioActive],
          onChangeSource: _classPrivateFieldLooseBase12(this, _changeSource)[_changeSource],
          onStartRecording: _classPrivateFieldLooseBase12(this, _startRecording)[_startRecording],
          onStopRecording: _classPrivateFieldLooseBase12(this, _stopRecording)[_stopRecording],
          onDiscardRecordedAudio: _classPrivateFieldLooseBase12(this, _discardRecordedAudio)[_discardRecordedAudio],
          onSubmit: _classPrivateFieldLooseBase12(this, _submit)[_submit],
          onStop: _classPrivateFieldLooseBase12(this, _stop)[_stop],
          i18n: this.i18n,
          ...
          stream: _classPrivateFieldLooseBase12(this, _stream)[_stream]
        })
      );
    }
    install() {
      ...
      if (_classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices]) {
        _classPrivateFieldLooseBase12(this, _updateSources)[_updateSources]();
        _classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices].ondevicechange = () => {
          _classPrivateFieldLooseBase12(this, _updateSources)[_updateSources]();
          if (_classPrivateFieldLooseBase12(this, _stream)[_stream]) {
            let restartStream = true;
            const {
  ...
  function _hasAudioCheck2() {
    ...
    return _classPrivateFieldLooseBase12(this, _mediaDevices)[_mediaDevices].enumerateDevices().then((devices) => {
      return devices.some((device) => device.kind === "audioinput");
    });
  }
  function _getAudio2() {
    const mimeType = _classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks].find((blob2) => {
      var _blob$type;
      return ((_blob$type = blob2.type) == null ? void 0 : _blob$type.length) > 0;
    }).type;
    const fileExtension = getFileTypeExtension(mimeType);
    ...
    const blob = new Blob(_classPrivateFieldLooseBase12(this, _recordingChunks)[_recordingChunks], {
      type: mimeType
    });
    const file = {
      source: this.id,
  ...
  var _U8Afrom = typeof Uint8Array.from === "function" ? Uint8Array.from.bind(Uint8Array) : (it, fn = (x2) => x2) => new Uint8Array(Array.prototype.slice.call(it, 0).map(fn));
  ...
  var WebStorageUrlStorage = /* @__PURE__ */ function() {
    ...
    _createClass4(WebStorageUrlStorage2, [{
      ...
      key: "addUpload",
      value: function addUpload(fingerprint2, upload) {
        var id17 = Math.round(Math.random() * 1e12);
        var key = "tus::".concat(fingerprint2, "::").concat(id17);
  ...
  var _emitter3 = /* @__PURE__ */ _classPrivateFieldLooseKey13("emitter");
  var _events = /* @__PURE__ */ _classPrivateFieldLooseKey13("events");
  var EventTracker = class {
    constructor(emitter) {
      ...
      _classPrivateFieldLooseBase13(this, _emitter3)[_emitter3] = emitter;
    }
    on(event, fn) {
      _classPrivateFieldLooseBase13(this, _events)[_events].push([event, fn]);
      return _classPrivateFieldLooseBase13(this, _emitter3)[_emitter3].on(event, fn);
    }
    remove() {
      for (const [event, fn] of _classPrivateFieldLooseBase13(this, _events)[_events].splice(0)) {
        _classPrivateFieldLooseBase13(this, _emitter3)[_emitter3].off(event, fn);
      }
    }
  };
  ...
  var RateLimitedQueue = class {
    constructor(limit) {
      ...
      Object.defineProperty(this, _increaseLimit, {
        ...
        value: () => {
          ...
          for (let i3 = _classPrivateFieldLooseBase14(this, _downLimit)[_downLimit]; i3 <= this.limit; i3++) {
    ...
    run(fn, queueOptions) {
      if (!_classPrivateFieldLooseBase14(this, _paused)[_paused] && _classPrivateFieldLooseBase14(this, _activeRequests)[_activeRequests] < this.limit) {
        return _classPrivateFieldLooseBase14(this, _call)[_call](fn);
      }
      return _classPrivateFieldLooseBase14(this, _queue)[_queue](fn, queueOptions);
    }
  ...
  var _retryDelayIterator = /* @__PURE__ */ _classPrivateFieldLooseKey15("retryDelayIterator");
  var _queueRequestSocketToken = /* @__PURE__ */ _classPrivateFieldLooseKey15("queueRequestSocketToken");
  var _requestSocketToken = /* @__PURE__ */ _classPrivateFieldLooseKey15("requestSocketToken");
  var Tus = class extends BasePlugin {
    constructor(uppy, _opts) {
      ...
      _classPrivateFieldLooseBase15(this, _retryDelayIterator)[_retryDelayIterator] = (_this$opts$retryDelay = this.opts.retryDelays) == null ? void 0 : _this$opts$retryDelay.values();
      ...
      _classPrivateFieldLooseBase15(this, _queueRequestSocketToken)[_queueRequestSocketToken] = this.requests.wrapPromiseFunction(_classPrivateFieldLooseBase15(this, _requestSocketToken)[_requestSocketToken]);
    }
    handleResetProgress() {
      const files = {
        ...
        const defaultOnShouldRetry = (err) => {
          ...
          if (status === 429) {
            if (!this.requests.isPaused) {
              var _classPrivateFieldLoo;
              const next = (_classPrivateFieldLoo = _classPrivateFieldLooseBase15(this, _retryDelayIterator)[_retryDelayIterator]) == null ? void 0 : _classPrivateFieldLoo.next();
    ...
    async uploadRemote(file) {
      ...
      try {
        ...
        const serverToken = await _classPrivateFieldLooseBase15(this, _queueRequestSocketToken)[_queueRequestSocketToken](file);
  ...
  var MetaDataStore = class {
    ...
    static cleanup(instanceID) {
      ...
      const now = Date.now();
      instanceIDs.forEach((id17) => {
        const data = localStorage.getItem(`uppyState:${id17}`);
        if (!data)
          return;
        ...
        if (obj.expires && obj.expires < now) {
          localStorage.removeItem(`uppyState:${id17}`);
        }
      });
    }
  };
  ...
  var GoldenRetriever = class extends BasePlugin {
    ...
    deleteBlobs(fileIDs) {
      const promises = [];
      fileIDs.forEach((id17) => {
        if (this.ServiceWorkerStore) {
          promises.push(this.ServiceWorkerStore.delete(id17));
        }
        if (this.IndexedDBStore) {
          promises.push(this.IndexedDBStore.delete(id17));
        }
      });
  ...
  var _RateLimitedQueue = /* @__PURE__ */ _classPrivateFieldLooseKey16("RateLimitedQueue");
  var Compressor = class extends BasePlugin {
    constructor(uppy, opts) {
      ...
      _classPrivateFieldLooseBase16(this, _RateLimitedQueue)[_RateLimitedQueue] = new RateLimitedQueue(this.opts.limit);
      this.i18nInit();
    ...
    async prepareUpload(fileIDs) {
      ...
      const compressAndApplyResult = _classPrivateFieldLooseBase16(this, _RateLimitedQueue)[_RateLimitedQueue].wrapPromiseFunction(async (file) => {
        try {
